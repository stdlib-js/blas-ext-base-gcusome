...
```javascript
import gcusome from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcusome@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcusome@deno/mod.js';
```
...
import falses from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-falses@deno/mod.js';
import gcusome from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcusome@deno/mod.js';
